    ...
    <>
      ...
      >
        ...
        >
          <Icon
            icon={
              data.profits.total_profit_this_month <
      ...
      >
        ...
        <div className="flex flex-col rtl:space-x-reverse">
          <div className="text-sm">
            <span className={`mb-[2px]`}>
              {data.merchants.total_merchants_this_month.toLocaleString()}{" "}
            </span>
            <span className=" text-slate-600 dark:text-slate-300">
              this month
            </span>
        ...
        >
          <Icon
            icon={
              data.merchants.total_merchants_this_month <
      ...
      >
        ...
        <div className="flex flex-col rtl:space-x-reverse">
          <div className="text-sm">
            <span className={`mb-[2px]`}>
              {data.riders.total_riders_this_month.toLocaleString()}{" "}
            </span>
            <span className=" text-slate-600 dark:text-slate-300">
              this month
            </span>
        ...
        >
          <Icon
            icon={
              data.riders.total_riders_this_month <
      ...
      >
        ...
        <div className="flex flex-col rtl:space-x-reverse">
          <div className="text-sm">
            <span className={`mb-[2px]`}>
              {data.customers.total_customers_this_month.toLocaleString()}{" "}
            </span>
            <span className=" text-slate-600 dark:text-slate-300">
              this month
            </span>
        ...
        >
          <Icon
            icon={
              data.customers.total_customers_this_month <
              data.customers.total_customers_last_month
                ? "heroicons:arrow-trending-down"
                : "heroicons:arrow-trending-up"
            }
          />{" "}
